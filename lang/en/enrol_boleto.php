...
$string['boletoprintandpayinfodirectlink'] = 'Você pode acessar este <a href="{$a}" target="_blank">link para ver e imprimir o boleto</a>.';
$string['boletoprintandpayinfoparceladolink1'] = '<a href="{$a} target="_blank"">Ver e imprimir o primeiro boleto, a ser pago a vista</a>.';
$string['boletoprintandpayinfoparceladolink2'] = '<a href="{$a} target="_blank"">Ver e imprimir o segundo boleto, a ser pago em até 30 dias</a>.';
$string['boletoprintandpayinfoparceladolink3'] = '<a href="{$a}" target="_blank">Ver e imprimir o terceiro boleto, a ser pago em até 60 dias</a>.';
$string['boletoprintandpayinfoparceladolink4'] = '<a href="{$a}" target="_blank">Ver e imprimir o terceiro boleto, a ser pago em até 90 dias</a>.';
...
$string['paymentavista'] = 'A vista no boleto';
$string['paymentparcelado'] = 'Parcelado no boleto';
...
$string['paymentavista'] = 'Pagamento à vista';
$string['paymentboleto'] = 'Pagamento parcelado';
